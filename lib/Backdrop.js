	...
	$( function () {
		...
		if ( $backDropRoot.length ) {
			...
			if ( $backgroundURL !== undefined ) {
				...
				'background-attachment': 'fixed', 'width': '100vw', 'margin': 'unset', 'padding-right': '10rem' } );
			...
			$( 'table.infoboxTable' ).css( { 'border-radius': '1rem', 'padding': '20rem' } );
			...
			if ( $hasCover !== undefined ) {
				...
				'position': 'absolute', 'bottom': '5rem', 'justify-content': 'space-between', 'z-index': -1} );
